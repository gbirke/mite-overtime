...
describe( 'buildMonthsFromWeeks', function () {
	...
	it( 'builds a month with a single week', function () {
		var firstWeek = Week.createWeekFromMoment( createDate( 2015, 9, 5 ) ),
		weeks = { 41: firstWeek },
	...
	it( 'builds a month with multiple weeks', function () {
		var firstWeek = Week.createWeekFromMoment( createDate( 2015, 9, 5 ) ),
		secondWeek = Week.createWeekFromMoment( createDate( 2015, 9, 12 ) ),
		thirdWeek = Week.createWeekFromMoment( createDate( 2015, 9, 19 ) ),
            weeks = {
	41: firstWeek,
	42: secondWeek,
	43: thirdWeek
	...
	it( 'builds multiple months when multiple weeks across month boundaries are given', function () {
		var firstWeek = Week.createWeekFromMoment( createDate( 2015, 9, 1, 40 ) ), // 28th Sep - 4th Oct
		secondWeek = Week.createWeekFromMoment( createDate( 2015, 9, 5, 41 ) ), // 4th Oct - 11th Oct
		thirdWeek = Week.createWeekFromMoment( createDate( 2015, 9, 26, 44 ) ), // 26th Oct - 1st Nov
            weeks = {
	40: firstWeek,
	41: secondWeek,
	44: thirdWeek
